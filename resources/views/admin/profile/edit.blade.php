            ...
            <div class="col-md-8 mx-auto">
                ...
                <form action="{{ action('Admin\ProfileController@update') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="radio" class="radio" name="gender" value="{{ $profile_form->gender }}" checked="checked">男
                             <input type="radio" class="radio" name="gender" value="{{ $profile_form->gender }}">女
                        </div>
                    </div>
                     <div class="form-group row">
